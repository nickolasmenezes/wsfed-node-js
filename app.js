...
passport.use(new wsfedsaml2(
  {
    path: '/login/callback',
    realm: 'urn:node:app',
    homeRealm: 'http://localhost:3000/', // specify an identity provider to avoid showing the idp selector
    identityProviderUrl: 'https://localhost:10001/fediz-idp/federation/up',
